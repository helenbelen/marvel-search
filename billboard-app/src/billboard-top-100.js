...
const BILLBOARD_BASE_URL = 'http://127.0.0.1:3000/http://www.billboard.com';
 ...
 */
export const getChart = (name, date, cb) => {
    let chartName = name;
    let chartDate = date;
    let callback = cb;
...
export const buildURL = (name, date) => {
    let chartName = name;
    let chartDate = date;
    ...
    // build request URL string for specified chart and date
    return `${BILLBOARD_CHARTS_URL}${chartName}/${chartDate}`
}
